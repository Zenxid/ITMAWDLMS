...
<div class="container">
    ...
    <main>
        <div class="container">
            <div class="title">
                <h1 class="text-center">Due Date</h1>
            </div>
                ...
                <table>
                    ...
                    <tbody class="table-body">
                        ...
                        if (isset($_SESSION['id'])) {
                            ...
                            $query = "SELECT id, school_id, user_id, name, role, dept_section, book_cover, book_name, quantity, due_date, date
                                      FROM borrow 
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    $formattedDueTime = date("F j, Y", strtotime($row['due_date']));
                                    echo '<tr id="row_' . $row['id'] . '">';
                                    echo '<td>';
                                    echo '<div class="cart-info">';
                                    echo '<img src="data:image/jpeg;base64,'.$row['book_cover'].'">';
                                    echo '<p>' . $row['book_name'] . '</p>';
                                    echo '</div>';
                                    echo '</td>';
                                    echo '<td>' . $row['quantity'] . '</td>';
                                    echo '<td>' . $formattedDate . '</td>';
                                    echo '<td>' . $formattedDueTime . '</td>';
                                    echo '</tr>';
                                }
                            } else {
    ...
    <div id="circle-menu" class="circle-menu">
        <div id="menu-toggle" class="menu-toggle">
            <div class="menu-icon"><i class="icon ph-bold ph-calendar-blank"></i></div>
            </div>
