...
<div class="container">
    ...
    <main>
        <div class="container">
            <div class="title">
                <h1 class="text-center">PC History</h1>
            </div>
                    ...
                    <tbody class="table-body">
                        ...
                        if (isset($_SESSION['id'])) {
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                echo "<tbody id='table-body'><tr><td colspan='5' style='text-align:center;'>No Data Found!</td></tr></tbody>";
                            }
                        } else {
                            echo "<tbody id='table-body'><tr><td colspan='5' style='text-align:center;'>No Login User!</td></tr></tbody>";
                        }
                        ?>
                    </tbody>
                </table>
    ...
    <div id="circle-menu" class="circle-menu">
        <div id="menu-toggle" class="menu-toggle">
            <div class="menu-icon"><i class="icon ph ph-clock-counter-clockwise"></i></div>
            </div>
