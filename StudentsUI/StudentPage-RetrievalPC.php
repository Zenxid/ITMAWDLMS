...
<div class="container">
    ...
    <main>
        <div class="container">
            <div class="title">
                <h1 class="text-center">PC Timer Table</h1>
            </div>
                ...
                <table>
                    ...
                    <tbody class="table-body">
                        ...
                        if (isset($_SESSION['id'])) {
                            ...
                            $query = "SELECT id, pc_id, picture, name, user_pic, user_name, user_id, timestamp, date, due_time
                                      FROM pc_activity 
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo '<img src="data:image;base64,' . $row['picture'] . '" alt="" />';
                                    echo '<div>';
                                    echo '<p>' . $row['name'] . '</p>';
                                    echo '</div>';
                                    echo '</div>';
