...
<div class="sidebar">
    ...
    <main>
        <div class="title">
            <h1 class="text-center">Book Favorite</h1>
            <input type="search" class="search" name="search" id="searchbar" onkeyup="filterFavorites()" placeholder="Enter Book Name...">
        </div>
...
$(document).ready(function(){
    $('#scrollable-table').on('click', '.remove', function(){
        ...
        $.ajax({
            url: 'PHP/delete_favoriteBook.php',
            type: 'POST',
            data: {id: rowId},
