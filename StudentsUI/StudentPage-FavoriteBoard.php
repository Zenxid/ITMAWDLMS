...
<head>
    ...
    <title>Favorite Board Games</title>
...
<div class="container">
    ...
    <main>
        <div class="title">
            <h1 class="text-center">Board Games Favorite</h1>
            <input type="search" class="search" name="search" id="searchbar" onkeyup="filterFavorites()" placeholder="Enter Board Game">
        </div>
        <div class="table-container">
            <table width="100%" id="scrollable-table">
                <thead>
                    <tr>
                        <td width="50%">Board Game</td>
                        <td></td>
                        <td width="10%"></td>
                    </tr>
                </thead>
...
$(document).ready(function(){
    $('#scrollable-table').on('click', '.remove', function(){
        ...
        $.ajax({
            url: 'PHP/delete_favoriteBoard.php',
            type: 'POST',
            data: {id: rowId},
