...
<head>
    ...
    <title>Fines</title>
    <link rel="stylesheet" href="CSS/StudentPage-Fines.css?v=<?php echo time(); ?>">
...
<div class="container">
                        ...
                        if (isset($_SESSION['id'])) {
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo '<td><button class="payment"><i class="bx bx-wallet"></i></button></td>';
                                    echo '</tr>';
                                }
                            } else {
    ...
    <div id="circle-menu" class="circle-menu">
        <div id="menu-toggle" class="menu-toggle">
            <div class="menu-icon"><i class="icon ph ph-money"></i></div>
            </div>
