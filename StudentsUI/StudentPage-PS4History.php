...
<head>
    ...
    <title>PS4 Games Returned</title>
...
<div class="container">
    ...
    <main>
        <div class="container">
            <div class="title">
                <h1 class="text-center">PS4 Games Returned</h1>
            </div>
                ...
                <table>
                    ...
                    <tbody class="table-body">
                        ...
                        if (isset($_SESSION['id'])) {
                            ...
                            echo "<tbody id='table-body'><tr><td colspan='5' style='text-align:center;'>User not logged in!</td></tr></tbody>";
                        }
                        ?>
                    </tbody>
                </table>
