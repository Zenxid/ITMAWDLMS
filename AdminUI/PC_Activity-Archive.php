...
<head>
    ...
    <title>PC Archive Activity</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="main">
            <div class="top-bar">
                <div class="top-title">PC Archive Activity</div>
            </div>
                ...
                <div class="table-wrap">
                    <div class="table_container">
                        <div class="table_header">
                            <p class="title">PC Archive Activity Table:</p>
                            <div>
                    ...
                    <table width="100%">
                        ...
                        <tbody id="tableBody">
                            <?php
                            $select_query = "SELECT * FROM `pc_activity_archive`";
