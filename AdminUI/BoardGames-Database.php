...
if(isset($_GET['deleteid'])){
    ...
    $fetch_sql = "SELECT * FROM `board_games` WHERE id=$id";
    $fetch_result = mysqli_query($con, $fetch_sql);
    $deleted_row = mysqli_fetch_assoc($fetch_result);

    
    $archive_sql = "INSERT INTO `boardgames_archive` (id, cover, name, description, quantity) VALUES (?, ?, ?, ?, ?)";
    $archive_stmt = mysqli_prepare($con, $archive_sql);
    if ($archive_stmt) {
        mysqli_stmt_bind_param($archive_stmt, "issss", $id, $deleted_row['cover'], $deleted_row['name'], $deleted_row['description'], $deleted_row['quantity']);
    ...
    $delete_sql="DELETE FROM `board_games` WHERE id=$id";
    $delete_result=mysqli_query($con, $delete_sql);
    if($delete_result){
        header('location:BoardGames-Database.php');
    } else {
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `board_games` (cover, name, description, quantity) VALUES (?, ?, ?, ?)";
    $stmt = mysqli_prepare($con, $sql);

    if ($stmt) {
        mysqli_stmt_bind_param($stmt, "sssi", $cover, $name, $description, $quantity);
...
<head>
    ...
    <title>Board Games Database</title>
    <link rel="stylesheet" href="CSS/BoardGame_Database.css">
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="main">
            <div class="top-bar">
                <div class="top-title">Board Games Database</div>
            </div>
            <!------- END OF TOP-BAR ------>
            <div class="table">
                <div class="table_header">
                    <p>Board Games Database Table:</p>
                    <div>
                ...
                <div class="table_section">
                    <table id="bookTable">
                        ...
                        <tbody id="tableBody">
                            ...
                            $sql="Select * from `board_games` $whereClause";
                            ...
                            if($result){
                                while($row=mysqli_fetch_assoc($result)) {
                                    ...
                                    <td class="button-container">
                                        ...
                                        <form method="post" action="BoardGames-Database.php?deleteid='.$id.'">
            ...
            <div class="popup">
                ...
                <h2>Fill the Form</h2>
                <form action="BoardGames-Database.php" method="post" enctype="multipart/form-data">
                    <div class="form">
                        <div class="img-card">
                            ...
                            <img id="previewImage" src="../Pictures/boardCover.png" alt="" width="200" height="200">
                        </div>
                        <div class="form-card">
                ...
                <form action="BoardGames-Database.php" method="post" enctype="multipart/form-data">
                    <div class="form">
                        <div class="img-card">
                            ...
                            <img id="previewImageModal" src="../Pictures/boardCover.png" alt="" width="200" height="200">
                        </div>
                        <div class="form-card">
                            <div class="form-element">
                            ...
                            <div class="form-element">
                                <label for="quantity">Quantity:</label>
                                <input type="text" id="quantity" placeholder="Enter Quantity" name="quantity" autocomplete="off">
                            </div>
                            <div class="form-element">
...
$(document).ready(function () {
    ...
    $('.update-btn').click(function (e){
        ...
        $.ajax({
            method: "POST",
            url: "PHP/retrievalBoardGames.php",
            data: {
