...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['id'])) {
        ...
        if ($result) {
            ...
            $html .= '<button class="check" id="successCheck" data-book-id="' . $row['id'] . '" data-row-id="' . $row_id . '"><i class="bx bx-check-circle"></i></button>';
            ...
            $html .= '<div class="user-details">';
            $html .= '<h4>Quantity: </h4>';
            $html .= '<p>' . $row['quantity'] . '</p>';
            $html .= '</div>';
            $html .= '<div class="user-details">';
            $html .= '<h4>Due Date: </h4>';
            $html .= '<p>' . $row['due_date'] . '</p>';
            $html .= '</div>';
            $html .= '<div class="user-details">';
            $html .= '</div>';
            $html .= '</div>';
            ...
            $html .= '<div class="button-details">';
            $html .= '<button class="check" id="failedCheck" data-book-id="' . $row['id'] . '" data-row-id="' . $row_id . '"><i class="bx bx-check-circle"></i></button>';
            $html .= '<button class="x"><i class="bx bx-x-circle"></i></button>';
            $html .= '</div>';
            $html .= '</div>';
            $html .= '<div class="container-grid">';
