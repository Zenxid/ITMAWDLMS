...
if (isset($_POST['retrieval'])) {
    ...
    $fetch_sql = "SELECT * FROM `ps4_archive` WHERE id=$id";
    $fetch_result = mysqli_query($con, $fetch_sql);
    $row = mysqli_fetch_assoc($fetch_result);

    $insert_sql = "INSERT INTO `ps4` (id, cover, name, description, genre) VALUES (?, ?, ?, ?, ?)";
    $insert_stmt = mysqli_prepare($con, $insert_sql);
    if ($insert_stmt) {
        mysqli_stmt_bind_param($insert_stmt, "issss", $row['id'], $row['cover'], $row['name'], $row['description'], $row['genre']);
        if (!mysqli_stmt_execute($insert_stmt)) {
            echo "Error restoring data: " . mysqli_stmt_error($insert_stmt);
        } else {

            $delete_sql = "DELETE FROM `ps4_archive` WHERE id=$id";
...
if(isset($_GET['deleteid'])){
    ...
    $sql="delete from `ps4_archive` where id=$id";
...
<body>
    <div class="container">
        ...
        <div class="main">
            <div class="top-bar">
                <div class="top-title">PS4 Archive</div>
            </div>
            <!------- END OF TOP-BAR ------>
            <div class="table">
                <div class="table_header">
                    <p>PS4 Information Table:</p>
                    <div>
                ...
                <div class="table_section">
                    <table id="bookTable">
                        ...
                        <tbody id="tableBody">
                            ...
                            $sql="Select * from `ps4_archive` $whereClause";
                            $result=mysqli_query($con,$sql);
                            ...
                            if($result){
                                while($row=mysqli_fetch_assoc($result)) {
                                    ...
                                    <form method="post" action="PS4-Archive.php">
                                    ...
                                    <form method="post" action="PS4-Archive.php?deleteid='.$id.'">
                ...
                <div class="form">
                    ...
                    <div class="form-card">
                        ...
                        <div class="form-element">
                            ...
                            <div class="readonly" id="description"></div>
                        </div>
                        <div class="form-element">
                            <label>Genre:</label>
                            <div class="readonly" id="genre"></div>
                        </div>
                    </div>
                </div>
            </div>
...
$('.view-btn').click(function (e){
    ...
    $.ajax({
        method: "POST",
        url: "PHP/retrievalPS4Archive.php",
        data: {
