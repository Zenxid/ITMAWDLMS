...
if(isset($_GET['deleteid'])){
    ...
    $fetch_sql = "SELECT * FROM `pc` WHERE id=$id";
    $fetch_result = mysqli_query($con, $fetch_sql);
    $deleted_row = mysqli_fetch_assoc($fetch_result);

    
    $archive_sql = "INSERT INTO `pc_archive` (id, cover, name) VALUES (?, ?, ?)";
    $archive_stmt = mysqli_prepare($con, $archive_sql);
    if ($archive_stmt) {
        mysqli_stmt_bind_param($archive_stmt, "iss", $id, $deleted_row['cover'], $deleted_row['name']);
    ...
    $delete_sql="DELETE FROM `pc` WHERE id=$id";
    $delete_result=mysqli_query($con, $delete_sql);
    if($delete_result){
        header('location:PC-Database.php');
    } else {
...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `pc` (cover, name) VALUES (?, ?)";
    $stmt = mysqli_prepare($con, $sql);

    if ($stmt) {
        mysqli_stmt_bind_param($stmt, "ss", $cover, $name);
...
<head>
    ...
    <title>PC Database</title>
    <link rel="stylesheet" href="CSS/PC-Database.css">
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="main">
            <div class="top-bar">
                <div class="top-title">PC Database</div>
            </div>
            <!------- END OF TOP-BAR ------>
            <div class="table">
                <div class="table_header">
                    <p>PC Database Table:</p>
                    <div>
                ...
                <div class="table_section">
                    <table id="bookTable">
                        ...
                        <tbody id="tableBody">
                            ...
                            $sql="Select * from `pc` $whereClause";
                            ...
                            if($result){
                                while($row=mysqli_fetch_assoc($result)) {
                                    ...
                                    <td class="button-container">
                                        ...
                                        <form method="post" action="PC-Database.php?deleteid='.$id.'">
            ...
            <div class="popup">
                ...
                <h2>Fill the Form</h2>
                <form action="PC-Database.php" method="post" enctype="multipart/form-data">
                    <div class="form">
                        <div class="img-card">
    ...
    <script src="JAVASCRIPT/PC-Database.js"></script>
