...
<head>
    ...
    <title>Board Games Activity</title>
    <link rel="stylesheet" href="CSS/sidebar.css">
    <link rel="stylesheet" href="CSS/BoardGame_Activity.css?v=<?php echo time(); ?>">
...
<body>
    <div class="container">
        ...
        <div class="main">
            <div class="top-bar">
                <div class="top-title">Board Games Activity</div>
            </div>
            ...
            <div class="board">
                <div class="table-wrap">
                    <div class="table_container">
                        <div class="table_header">
                            <p class="title">Board Games Activity Table:</p>
                            <div>
                ...
                <table width="100%">
                     ...
                     <tbody id="table-body">
                        ...
                        $query = "SELECT `id`, `picture`, `name`, `user_name`, `timestamp`, `date` FROM `boardgames_activity`";
    ...
    <script src="JAVASCRIPT/BoardGame_Activity.js"></script>
...
$(document).ready(function() {
    $('.remark-btn').click(function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'PHP/BoardGame_fetch_remark.php',
            data: { id: id },
    ...
    $(document).on('click', '#successCheck', function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'PHP/insert_to_BoardGamesarchive.php',
            data: { id: id, remark: remark },
            success: function(response) {
                showCustomToast("Board Games successfully archive", true)
                $('#' + row_id).remove();
                reloadTable();
            },
            error: function() {
    ...
    $(document).on('click', '#failedCheck', function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'PHP/insert_to_BoardGamesfines.php',
            data: { id: id, remark: remark, price: price },
            success: function(response) {
                showCustomToast("Board Games successfully notify to student fines", true)
                $('#' + row_id).remove();
                reloadTable();
            },
            error: function() {
    ...
    function reloadTable() {
        $.ajax({
            type: 'GET',
            url: 'PHP/BoardGame_reload_table.php',
            success: function(response) {
