            ...
            <div class="board">
                <div class="table-wrap">
                    ...
                    <table id="myTable" width="100%">
                        ...
                        <tbody id="table-body">
                            <?php
                                $select_query = "SELECT * FROM `fines`";
...
$(document).ready(function() {
    $('.insert-button').on('click', function() {
        ...
        $.ajax({
            type: "POST",
            url: "PHP/insert_into_Finesarchive.php",
            data: { id: id },
            success: function(response) {
                showCustomToast(response, true);
                $('#' + row_id).remove();
                reloadTable();
            },
            error: function(xhr, status, error) {
                console.error(xhr.responseText);
                showCustomToast("Failed to insert into archive", false);
            }
        });
    });
});
...
function reloadTable() {
        $.ajax({
            type: 'GET',
            url: 'PHP/Fines_reload_table.php',
            success: function(response) {
