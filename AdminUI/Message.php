...
<div class="sidebar">
        ...
        <div class="main">
            ...
            <div class="box-containers">
                <a href="#">
                    <div class="box"><i class='bx bx-notepad'></i><p>REMARKS</p></div>
                </a>
                <a href="#">
                    <div class="box"><i class='bx bxs-envelope' ></i><p>EMAIL</p></div>
                </a>
                <a href="#">
                    <div class="box"><i class='bx bxs-message-alt-detail'></i><p>SMS</p></div>
                </a>
            </div>
            <div class="box-containers">
                <a href="#">
                    <div class="box"><i class='bx bxs-bell-ring'></i><p>NOTIFY</p></div>
                </a>
