...
$query = "SELECT picture, name, user_id, timestamp, date FROM ps4_activity";
...
<head>
    ...
    <title>PS4 Activity</title>
    <link rel="stylesheet" href="CSS/PS4_Activity.css?v=<?php echo time(); ?>">
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="main">
            <div class="top-bar">
                <div class="top-title">PS4 Activity</div>
            </div>

            <div class="board">
                <div class="table-wrap">
                    <div class="table_header">
                        <p class="title">PS4 Activity Table:</p>
                        <div>
    ...
    <script src="JAVASCRIPT/PS4_Activity.js?v=<?php echo time(); ?>"></script>
...
$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                const availableOption = [
                    "Successfully Received and Early Out",
                    "Successfully Received in Perfect Condition",
                    "Successfully Received but Late Out (10 mins)"
                ];
                ...
                const finesOption = [
                    "Early Out But Bad Condition",
                    "Badly Condition Game Disc",
                    "Badly Condition Controller",
                    "Badly Condition PS4",
                    "Badly Condition Screen",
                    "Badly Condition Camera",
                    "Broke The Game Disc",
    ...
    $(document).on('click', '#successCheck', function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'PHP/insert_to_PS4archive.php',
            data: { id: id, remark: remark },
            success: function(response) {
                showCustomToast("PS4 successfully archive", true)
                $('#' + row_id).remove();
                reloadTable();
            },
            error: function() {
    ...
    $(document).on('click', '#failedCheck', function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'PHP/insert_to_PS4fines.php',
            data: { id: id, remark: remark, price: price },
            success: function(response) {
                showCustomToast("PS4 successfully notify to student fines", true)
                $('#' + row_id).remove();
                reloadTable();
            },
            error: function() {
