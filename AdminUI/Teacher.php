...
if (!empty($searchTerm)) {
    $whereClause = " WHERE name OR school_id LIKE '%$searchTerm%'";
    $sql .= $whereClause;
}
            ...
            <div class="board">
                <div class="table-wrap">
                    <div class="table_header">
                        <p class="title">Teacher Table:</p>
                        <form method="GET">
                            <input type="text" name="search" value="<?php echo htmlspecialchars($searchTerm); ?>" placeholder="Search" />
                        </form>
                    </div>
                <table id="teacher-table" width="100%">
                     <thead>
                        <tr>
                            <td style="width: 2%;">Faculty ID</td>
                     ...
                     <?php
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo '<tr>
                                        <td class="id">' . $schlID . '</td>
                                        <td class="profile"><img src="data:image;base64,' . $picture . '" alt="Teacher Picture"></td>
                                        <td class="name">' . $name . '</td>
                                        <td class="role">' . $faculty . '</td>
                                      </tr>';
                            }
                        } else {
