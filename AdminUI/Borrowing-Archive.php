...
<div class="container">
    <div class="sidebar">
        ...
        <div class="main">
            <div class="top-bar">
                <div class="top-title">Borrow Archive</div>
            </div>
                ...
                <div class="table-wrap">
                    <div class="table_container">
                        <div class="table_header">
                            <p class="title">Borrow Archive Table:</p>
                            <div>
                    ...
                    <table width="100%">
                        ...
                        <tbody id="tableBody">
                            <?php
                            $select_query = "SELECT * FROM `borrow_archive`";
...
function renderTable(data) {
    ...
    data.forEach(row => {
        ...
        tr.innerHTML = `
            <td><p>${row.school_id}</p></td>
            <td><p>${row.name}</p></td>
            <td><p>${row.role}</p></td>
            <td><p>${row.dept_section}</p></td>
