...
<head>
    ...
    <title>Board Games Archive Activity</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="main">
            <div class="top-bar">
                <div class="top-title">Board Games Archive Activity</div>
            </div>
                ...
                <div class="table-wrap">
                    <div class="table_container">
                        <div class="table_header">
                            <p class="title">Board Games Archive Activity Table:</p>
                            <div>
                    ...
                    <table width="100%">
                        ...
                        <tbody id="tableBody">
                            <?php
                            $select_query = "SELECT * FROM `boardgames_activity_archive`";
...
function renderTable(data) {
    ...
    data.forEach(row => {
        ...
        tr.innerHTML = `
            <td><img src="data:image/jpeg;base64,${row.picture}"></img></td>
            <td><p>${row.name}</p></td>
